...
class ZohoClient:
    ...
    def find_record_id_by_external_key(
        self, report: str, field: str, value: str, priority: int
    ) -> str | None:
        criteria = f'({field} == "{value}")'
        ...
        if isinstance(data, list) and data:
            ...
            if isinstance(rec, dict):
                rid = rec.get("ID") or rec.get("id") or rec.get("zc_record_id")
